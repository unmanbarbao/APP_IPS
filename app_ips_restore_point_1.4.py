            ...
            if option == "Verificación de Facturas":
                ...
                ttk.Button(button_frame, text=option, 
                          ...
                          style='Regime.TButton').grid(row=row, column=col, 
                                                     padx=5, pady=5, 
                                                     sticky="ew")
            elif option == "Empaquetar facturas de un rango específico":
                ttk.Button(button_frame, text=option, 
                          command=lambda r=regime: self.package_invoices_range(r),
                          style='Regime.TButton').grid(row=row, column=col, 
                                                     padx=5, pady=5, 
                                                     sticky="ew")
            elif option == "Empaquetar soportes del rango específico":
                ttk.Button(button_frame, text=option, 
                          command=lambda r=regime: self.package_supports_range(r),
                          style='Regime.TButton').grid(row=row, column=col, 
                                                     padx=5, pady=5, 
                                                     sticky="ew")
            else:
